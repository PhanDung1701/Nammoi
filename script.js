...
const soundEnabledSelector = (state = store.state) => true; // Luôn trả về true để đảm bảo âm thanh luôn được bật.
...
// Các hàm selector khác không thay đổi.
...
function handleStateChange(state, prevState) {
	...
	const canPlaySound = true; // Luôn đặt giá trị là true để đảm bảo âm thanh luôn được bật.
